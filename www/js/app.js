...
.run(function($ionicPlatform, datosdesesion, $location, $rootScope) {
  ...
  if( window.localStorage.starter_google_user !== undefined){
   ...
   if (window.localStorage.starter_google_user+"" == "{}") {
        console.log("vacio");
           $rootScope.$apply(function() { 
      $location.path("login"); console.log($location.path()); 
    });
   }
   else
   {
    console.log("algo tintr");
     $rootScope.$apply(function() { 
      $location.path("/tab/lugar"); console.log($location.path()); 
    });
   }
